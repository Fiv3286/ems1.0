 ...
 * 
 * Reference: page 1.1 in the Figma design
 */
...
function CommitteeSelection() {
    ...
    useEffect(() => {
        ...
        setLoading(true)
        api.get('conferences/committees', {params: {year}})
        .then(res => {
            setLoading(false)
                ...
                {committeeList.map(displayCommittee => {
                    return (
                        ...
                        <Button 
                            ...
                            variant='contained'
                            onClick={() => navigator(`/chair/${displayCommittee}/${year}/selection`)}
                            // /chair/:committee/selection
